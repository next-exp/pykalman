...
# Output directories
trk_outdir = "/Users/Gonzalo/Dropbox/Gonzalo/Facultade/NEXT/KalmanFilter/output/tracks";
#trk_outdir = "/data4/NEXT/users/jrenner/kalmanfilter/out/tracks";    # output directory for tracks
fit_outdir = "/Users/Gonzalo/Dropbox/Gonzalo/Facultade/NEXT/KalmanFilter/output/fits";
#fit_outdir = "/data4/NEXT/users/jrenner/kalmanfilter/out/ifit";      # output directory for track fits
plt_outdir = "/Users/Gonzalo/Dropbox/Gonzalo/Facultade/NEXT/KalmanFilter/output/plots";
#plt_outdir = "/data4/NEXT/users/jrenner/kalmanfilter/out/iplots";    # output directory for plots

trk_name = "singlebeta";   # name assigned to this run; will be used in naming the output files
num_tracks = 100;     # number of tracks to generate and/or fit

chi2_low = 1.0e-5;     # lower chi2 boundary for certain chi2 analyses
chi2_outlier = 40.;     # upper chi2 boundary for chi2 profile and other analyses
...
prof_name = "singlebeta";  # name of run used to generate the profiles (only relevant if running fitprof.py)
