...
class MPLDrawHits(KDrawHits.KDrawHits):
    """
    ...
    def __init__(self,binLimits,measurements,hits):
        ...
        KDrawHits.KDrawHits.__init__(self,binLimits,measurements,hits)
    ...
    def DrawMeasurements(self, draw='2D'):
        ...
        if draw == '2D':
            ...
            fig2D = matplotlib.pyplot.figure();
            ...
            fig3D = matplotlib.pyplot.figure();
